  ...
  async createWorld(page, permutation, config) {
    ...
    try {
      ...
      try {
        ...
        console.log(`[V12 World] ⚠️ Could not fill world title: ${e.message}`);
      }
      ...
      try {
        ...
        console.log(`[V12 World] ⚠️ Could not fill world ID: ${e.message}`);
      }
      ...
      try {
        ...
        if (systemField) {
          ...
          console.log('[V12 World] ⚠️ Game system field not found - this may cause world creation to fail');
        }
      } catch (e) {
        console.log(`[V12 World] ⚠️ Could not set game system: ${e.message} - this may cause world creation to fail`);
      }
      ...
      try {
        ...
        console.log(`[V12 World] ⚠️ Could not fill world description: ${e.message} - continuing without it`);
      }
