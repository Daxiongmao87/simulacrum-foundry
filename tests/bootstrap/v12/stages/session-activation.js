...
export class SessionActivationV12 {
  ...
  async run(page, permutation, config, port) {
    const worldLaunch = new WorldLaunchV12();
    const userAuthentication = new UserAuthenticationV12();
    const gameVerification = new GameVerificationV12();
    const enableModule = new EnableModuleV12();
