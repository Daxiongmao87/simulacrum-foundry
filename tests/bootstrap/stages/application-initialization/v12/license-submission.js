...
export class LicenseSubmissionV12 {
  ...
  async submitLicense(page, licenseKey) {
    console.log('[V12 License] 🔑 Submitting license key...');
    ...
    try {
      ...
      const result = await page.evaluate(async (licenseKey) => {
        try {
          ...
          if (licenseInput) {
            ...
            console.log('[V12 License] License key entered in input field');
          }
          ...
          if (submitButton) {
            submitButton.click();
            console.log('[V12 License] Submit button clicked');
          ...
          if (textButton) {
            textButton.click();
            console.log('[V12 License] Text-based submit button clicked');
      ...
      if (result.success) {
        ...
        console.log('[V12 License] Waiting for page navigation after license submission...');
        await page.waitForNavigation({ waitUntil: 'domcontentloaded', timeout: 30000 });
        console.log('[V12 License] Page navigation completed');
      }
