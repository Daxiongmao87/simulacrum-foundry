...
export class EULAHandlingV13 {
  ...
  async handleEULA(page) {
    console.log('Simulacrum | [V13 EULA] 📝 Checking for EULA...');
    ...
    try {
      ...
      console.log(`Simulacrum | [V13 EULA] 📍 EULA check:`, JSON.stringify(eulaCheck, null, 2));
      
      if (eulaCheck.detected) {
        console.log('Simulacrum | [V13 EULA] 📍 EULA detected, accepting agreement...');
        ...
        const result = await page.evaluate(() => {
          try {
            ...
            if (eulaCheckbox) {
              ...
              console.log('Simulacrum | [V13 EULA] EULA checkbox checked');
            }
            ...
            if (signButton) {
              signButton.click();
              console.log('Simulacrum | [V13 EULA] EULA sign button clicked');
            ...
            for (const button of buttons) {
              ...
              if (text.includes('sign') || text.includes('accept') || text.includes('agree') || text.includes('continue')) {
                button.click();
                console.log(`Simulacrum | [V13 EULA] EULA button clicked: ${button.textContent}`);
        ...
        if (result.success) {
          console.log('Simulacrum | [V13 EULA] ✅ EULA accepted successfully');
  ...
  async handleEULAOnSetupPage(page, config) {
    console.log('Simulacrum | [V13 EULA] 📝 Checking for EULA on setup page...');
    ...
    try {
      ...
      console.log('Simulacrum | [V13 EULA] 📍 EULA appeared on setup page, accepting agreement...');
      ...
      if (eulaResult.success) {
        console.log('Simulacrum | [V13 EULA] ✅ EULA accepted on setup page');
