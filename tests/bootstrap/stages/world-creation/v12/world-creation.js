...
export class WorldCreationV12 {
  ...
  async createWorld(page, permutation, config) {
    console.log(`Simulacrum | [V12 World] 🌍 Creating world for ${permutation.id}...`);
    ...
    try {
      ...
      try {
        ...
        console.log('Simulacrum | [V12 World] ✅ World title filled');
      } catch (e) {
      ...
      try {
        ...
        console.log('Simulacrum | [V12 World] ✅ World ID filled');
      } catch (e) {
      ...
      try {
        ...
        if (systemField) {
          ...
          if (tagName === 'SELECT') {
            ...
            console.log(`Simulacrum | [V12 World] ✅ Game system selected: ${permutation.system}`);
          } else {
            await page.type('input[name="system"], #world-config-system', permutation.system);
            console.log(`Simulacrum | [V12 World] ✅ Game system entered: ${permutation.system}`);
          }
        } else {
      ...
      try {
        ...
        console.log('Simulacrum | [V12 World] ✅ World description filled');
      } catch (e) {
        console.log('Simulacrum | [V12 World] ✅ World description not found (not required)');
      }
      
      // Submit form: keep only the Enter-key path which is proven to execute
      console.log('Simulacrum | [V12 World] 📍 Submitting world creation form (Enter key only)...');
      try {
        await page.keyboard.press('Enter');
        console.log('Simulacrum | [V12 World] ✅ World creation form submitted via Enter key');
      } catch (e2) {
      ...
      console.log('Simulacrum | [V12 World] 📊 Created world (derived):', JSON.stringify({ id: actualWorldId, title: actualWorldTitle }, null, 2));
      ...
      console.log(`Simulacrum | [V12 World] 📋 World presence in list (${actualWorldId}): ${foundInList}`);
