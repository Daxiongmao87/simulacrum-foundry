...
export class EnableModuleV13 {
  ...
  async enableModule(page, config) {
    try {
      ...
      console.log('Simulacrum | [V13 Module] 📍 Clicking settings button...');
      await page.click('.ui-control.plain.icon.fa-solid.fa-gears');
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Step 38: Click "Manage Modules" button
      console.log('Simulacrum | [V13 Module] 📍 Clicking Manage Modules...');
      ...
      console.log('Simulacrum | [V13 Module] 📍 Enabling Simulacrum module checkbox...');
      ...
      console.log('Simulacrum | [V13 Module] 📍 Saving module settings...');
      ...
      console.log('Simulacrum | [V13 Module] 📍 Confirming module activation (this will reload the page)...');
      ...
      console.log('Simulacrum | [V13 Module] 📍 Waiting for FoundryVTT to reinitialize after module activation...');
      ...
      const foundryLoadedPromise = new Promise((resolve) => {
        const listener = (msg) => {
          ...
          if (text.includes('Foundry VTT | Drawing game canvas for scene')) {
            console.log('Simulacrum | [V13 Module] ✅ FoundryVTT game canvas ready - full initialization complete');
      ...
      console.log('Simulacrum | [V13 Module] 📍 Waiting 10 seconds grace period for full initialization...');
      await new Promise(resolve => setTimeout(resolve, 10000));
      
      console.log('Simulacrum | [V13 Module] ✅ Module activation reload complete');
      console.log('Simulacrum | [V13 Module] ✅ Simulacrum module enabled in settings - module initialization will be verified by integration tests');
      return { success: true };
