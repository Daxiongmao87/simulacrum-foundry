...
export class ToolPermissionsConfig extends FormApplication {
    ...
    activateListeners(html) {
        ...
        html.find('.permission-cycle-button').on('click', this._onCyclePermission.bind(this));
    }
    ...
    _onCyclePermission(event) {
        ...
        button.text(game.i18n.localize(`SIMULACRUM.Permission${nextPermission.charAt(0).toUpperCase() + nextPermission.slice(1)}`));
        button.removeClass('permission-allow permission-confirm permission-deny')
    ...
    async _updateObject(event, formData) {
        ...
        ui.notifications.info(game.i18n.localize("SIMULACRUM.ToolPermissionsSaved"));
    }
}
