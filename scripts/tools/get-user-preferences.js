  ...
  constructor() {
    super(
      ...
      'Returns user-specific settings and preferences',
      {
        type: 'object',
        properties: {
          userId: { type: 'string', description: 'Specific user ID to get preferences for (optional, defaults to current user)' }
        },
    ...
    try {
      ...
      const userPreferences = {
        ...
        permissions: {
          ...
          hasSimulacrumAccess: SimulacrumSettings.hasSimulacrumPermission(targetUser)
        },
        simulacrumSettings: {},
        coreSettings: {}
      };
      ...
      if (SimulacrumSettings.hasSimulacrumPermission(targetUser)) {
        ...
        userPreferences.simulacrumSettings = {
          ...
          yoloMode: game.settings.get('simulacrum', 'yoloMode'),
