...
export class ManageTaskTool extends BaseTool {
    constructor() {
        super('manage_task', 'Manage complex tasks by breaking them into steps, tracking progress, and updating state.', {
            type: 'object',
            properties: {
                action: {
                    type: 'string',
    ...
    _finishTask() {
        ...
        this.currentTask.steps.forEach(s => { s.status = 'completed'; });
