...
export class ToolRegistry {
  ...
  /**
   * Confirm execution of a tool, respecting Gremlin mode and permissions.
   * @param {User} user
  ...
  async confirmExecution(user, toolName, params) {
    ...
    if (permission === 'autoconfirm') {
      ...
      ui.notifications.error(
        `Simulacrum | Tool ${toolName} execution denied by permissions.`
      );
      return false;
    }

    const dialogContent = await renderTemplate(
      'modules/simulacrum/templates/tool-confirmation.html',
      {
        toolName: toolName,
            ...
            yesAlways: {
              ...
              callback: () => {
                ...
                ui.notifications.info(
                  `Simulacrum | Tool '${toolName}' will now auto-confirm.`
                );
                resolve(true);
              },
            },
            modify: {
              ...
              callback: () => {
                ...
                ui.notifications.warn(
                  'Simulacrum | Parameter modification not yet fully implemented.'
                );
