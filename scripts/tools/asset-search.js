      ...
      BASE_DESCRIPTION, // Will be overridden by getter
      {
        ...
        properties: {
          ...
          type: {
            ...
            default: 'any',
            description:
              'The file type to filter by. Restricts results to files with matching extensions (e.g., "image" matches .webp/.png/.jpg, "audio" matches .mp3/.ogg/.wav). Defaults to "any".',
          },
          source: {
            type: 'string',
            enum: ['all', 'user', 'core'],
            default: 'all',
            description:
              'Where to search: "user" for uploaded assets and module files, "core" for Foundry built-in files, or "all" for both. Defaults to "all".',
          },
        },
        required: ['query'],
      }
