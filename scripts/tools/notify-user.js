    ...
    return this._addResponseParam({
      ...
      properties: {
        reason: {
          ...
          description:
            'Why the loop is ending: "task_complete" for successful completion, "need_clarification" when user input is required, "error" for unrecoverable failures, "question" when asking the user a question. Used for logging only.',
        },
      },
      required: [],
    });
